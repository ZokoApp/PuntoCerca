const CATEGORY_MAP = {
  "Gastronomía": [
    ...
    { id: 4, name: "Cafetería" },
    { id: 5, name: "Heladería" },
    { id: 56, name: "Comida rápida" },
    { id: 57, name: "Parrilla" },
    { id: 58, name: "Pastelería" }
  ],
  ...
  "Comercio": [
    ...
    // 🔥 nuevas
    { id: 59, name: "Repuestos refrigeración" },
    { id: 60, name: "Herramientas" },
    { id: 61, name: "Insumos técnicos" }
  ],
  ...
  "Belleza": [
    ...
    { id: 12, name: "Estética" },
    { id: 13, name: "Spa" },
    { id: 62, name: "Manicuría" },
    { id: 63, name: "Cosmética" }
  ],
  ...
  "Salud": [
    ...
    { id: 64, name: "Kinesiología" },
    { id: 65, name: "Laboratorio" }
  ],
  ...
  "Servicios": [
    ...
    { id: 66, name: "Refrigeración" },
    { id: 67, name: "Aire acondicionado" },
    { id: 68, name: "Instalaciones" },
    { id: 69, name: "Mantenimiento" },
    { id: 70, name: "Service técnico" }
  ],
  ...
  "Automotor": [
    ...
    { id: 71, name: "Electricidad automotor" },
    { id: 72, name: "Lubricentro" }
  ],
